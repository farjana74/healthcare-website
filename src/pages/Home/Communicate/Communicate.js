...
const Communicate = () => {
    return (
        <div className="container-fluid  communicate">
            <div className="row pt-5 text-white">
                <div className="col-md-3 d-flex mx-auto ">
                    <div>
                        <i class="fas fa-map-marker-alt hero-img"></i>
                    </div>
                    <div>
                        <h2>Location</h2>
                ...
                <div className="col-md-3 d-flex mx-auto ">
                    <div>
                        <i class="fas fa-ambulance hero-img"></i>
                    </div>
                    <div>
                        <h2>Ambulance</h2>
                ...
                <div className="col-md-3 d-flex  mx-auto ">
                    <div>
                        <i class="fas fa-phone-volume hero-img "></i>
                    </div>
                    <div>
